...
| 7 | `build/filters.ts` | Hygiene exclusions for `contrib/agentGraph/.../media/**` (indentation) and `media/vendor/**` (copyright) in `// FORK:agentGraph` blocks | Re-add the two marked globs |
